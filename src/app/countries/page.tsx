            ...
            {COUNTRIES.map((c) => (
              ...
              >
                <div className="relative h-[120px] w-[120px]">
                  <div className="absolute inset-0 rounded-full bg-white shadow-[0_10px_25px_rgba(0,0,0,0.08)] ring-1 ring-black/5 transition-transform group-hover:scale-[1.05]" />
                ...
                <p className="mt-3 text-md font-bold text-neutral-800">
                  {formatName(c.name)}
                </p>
              </button>
            ))}
