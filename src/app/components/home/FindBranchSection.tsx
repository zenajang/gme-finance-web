        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col items-center justify-center text-white">
          ...
          <div className="relative max-w-2xl w-full">
            ...
            <button
              ...
              className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-red-600 rounded-3xl hover:bg-red-700 transition-colors cursor-pointer"
            >
              <Image src="/images/icons/search.svg" alt="search" width={10} height={10} className="w-3 h-3 md:w-5 md:h-5 lg:w-5 lg:h-5"/>
            </button>
          </div>
        </div>
      </section>
